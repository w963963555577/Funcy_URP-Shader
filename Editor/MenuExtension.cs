...
public class MenuExtension
{
    ...
    /*
    [MenuItem("GameObject/Volumetric Rendering/Lighting Box", priority =11)]
    public static void VolumetricRenderingLightingBox()
    {
        GameObject prefab = AssetDatabase.LoadAssetAtPath<GameObject>("../Shaders/Volume/Volumetic Lighting Box.prefab");
        PrefabUtility.InstantiatePrefab(prefab);
    }
    [MenuItem("GameObject/Volumetric Rendering/Lighting Box", true)]
    static bool VolumetricRenderingLightingBox_Toggle()
    {
