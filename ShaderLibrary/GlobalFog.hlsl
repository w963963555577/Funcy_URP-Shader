...
half4 MixGlobalFog(float4 color, float3 positionWS)
{
    ...
    half g1 = SAMPLE_TEXTURE2D(_GlobalFogNoise, sampler_GlobalFogNoise, (positionWS.xz + _Time.y * 1.000 * float2(-0.317, -0.899641)) * _GlobalFogNoiseScale).r;
    half g2 = SAMPLE_TEXTURE2D(_GlobalFogNoise, sampler_GlobalFogNoise, (positionWS.xz + _Time.y * 0.513 * float2(0.217, -0.699641)) * _GlobalFogNoiseScale).r;
    half gray = max(g2, g1);
