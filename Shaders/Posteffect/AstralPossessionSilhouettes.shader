...
Shader "AstralPossessionSilhouettes"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                #endif
                float3 vertexValue = ( appendResult37 * float3( 0,0.1,0 ) );
                #ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18909
-1887;96;1866;984;322.5086;469.6389;1.3;True;False
...
Node;AmplifyShaderEditor.SimpleTimeNode;35;1112.9,482.0447;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SinOpNode;36;1310.829,445.4335;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;37;1517.911,366.4906;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;1689.526,379.0757;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0.1,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=94B82CE27FB9EB906A42A45B11585CD4773F12B2