	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult109 = (float2(IN.ase_texcoord3.zw.x , 1.0));
				float4 tex2DNode5 = tex2D( _MainTex, ( uv0_MainTex / appendResult109 ) );
				float2 uv0_DissolveTex = IN.ase_texcoord3.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
				float4 tex2DNode18 = tex2D( _DissolveTex, uv0_DissolveTex );
				float disslove78 = ( 1.0 - IN.ase_texcoord3.zw.y );
				float temp_output_54_0 = step( 1.0 , ( tex2DNode18.r + disslove78 ) );
				float temp_output_70_0 = pow( saturate( ( temp_output_54_0 * ( 1.0 - saturate( pow( ( (-1.0 + (disslove78 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + tex2DNode18.r ) , 5.0 ) ) ) ) ) , _EdgeNear );
				...
				float smoothstepResult100 = smoothstep( -0.1 , tex2DNode18.r , ( 1.0 - abs( ( ( IN.ase_texcoord3.xy - float2( 0.5,0.5 ) ) * float2( 2,2 ) ) ).y ));
		...
		Pass
		{
			...
			half4 ShadowPassFragment(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult109 = (float2(IN.ase_texcoord2.zw.x , 1.0));
				float4 tex2DNode5 = tex2D( _MainTex, ( uv0_MainTex / appendResult109 ) );
				float2 uv0_DissolveTex = IN.ase_texcoord2.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
				float4 tex2DNode18 = tex2D( _DissolveTex, uv0_DissolveTex );
				float disslove78 = ( 1.0 - IN.ase_texcoord2.zw.y );
				float temp_output_54_0 = step( 1.0 , ( tex2DNode18.r + disslove78 ) );
				float smoothstepResult100 = smoothstep( -0.1 , tex2DNode18.r , ( 1.0 - abs( ( ( IN.ase_texcoord2.xy - float2( 0.5,0.5 ) ) * float2( 2,2 ) ) ).y ));
				float smoothstepResult123 = smoothstep( 0.45 , 0.55 , smoothstepResult100);
				float temp_output_56_0 = ( tex2DNode5.r * temp_output_54_0 * smoothstepResult123 );
				clip( temp_output_56_0 - 0.01);
...
/*ASEBEGIN
Version=17800
-87;43;1421;693;697.5858;78.12164;1.3;True;False
...
Node;AmplifyShaderEditor.OneMinusNode;132;-39.33765,1.820129;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;97;-561.3688,1164.669;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;17;-1687.714,268.873;Inherit;True;Property;_DissolveTex;DissolveTex;2;0;Create;True;0;0;False;0;6a1fffff897d00e459ab3c9226cbedc6;6a1fffff897d00e459ab3c9226cbedc6;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;-32,-384;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;False;0;0c0411f89f1834a4cb6aee0a7964126c;0c0411f89f1834a4cb6aee0a7964126c;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;78;152.2398,-6.54349;Inherit;False;disslove;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;575.9699,-350.7593;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;72;128,384;Inherit;False;Property;_EdgeNear;EdgeNear;4;0;Create;True;0;0;False;0;5;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;76;575.9699,-526.7593;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;False;0;1,1,1,1;18.11321,4.074788,1.110716,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;64;229.0744,454.5971;Inherit;False;Property;_DissolveColor;DissolveColor;3;1;[HDR];Create;True;0;0;False;0;1,0.2351134,0,0;0.01750156,0.0006035022,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;1696.208,-122.8519;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;5;ZDShader/LWRP/Particles/Dissolve;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;7;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;11;Surface;1;  Blend;0;Two Sided;0;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;0;Meta Pass;0;Extra Pre Pass;0;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;False;False;False;;0
...
ASEEND*/
//CHKSM=C6D4BAFFFE62F555B0CC5EC2285228FD0A8CEC6D