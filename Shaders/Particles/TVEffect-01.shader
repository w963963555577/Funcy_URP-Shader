...
Shader "ZDShader/LWRP/Particles/TVEffect-01"
{
	Properties
	{
		...
		[HDR]_Color("Color", Color) = (0,0.1654572,0.2264151,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float temp_output_60_0 = abs( ( ( ( ( temp_output_28_0 * 1.5 ) + sin( ( ( temp_output_29_0 * ( _Density * 2.0 ) ) + mulTime33 ) ) ) + ( ( ( temp_output_28_0 * 2.0 ) + sin( ( ( temp_output_29_0 * _Density ) + ( mulTime33 * 1.5 ) ) ) ) * tex2DNode52.g ) ) + ( ( ( temp_output_28_0 * 0.5 ) + sin( ( ( temp_output_29_0 * ( _Density * 5.0 ) ) + mulTime33 ) ) ) * tex2DNode52.g ) ) );
				...
				float temp_output_63_0 = ( temp_output_107_0 * tex2DNode52.r * ( _Intensity * 0.1 ) * temp_output_68_0 );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 fetchOpaqueVal10 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( appendResult69 + appendResult84 ) ), 1.0 );
				float smoothstepResult111 = smoothstep( 0.0 , 1.0 , temp_output_107_0);
				float4 lerpResult108 = lerp( fetchOpaqueVal10 , ( fetchOpaqueVal10 + ( _Color * smoothstepResult111 ) ) , temp_output_68_0);
...
/*ASEBEGIN
Version=18104
-1440;176;1440;849;1419.512;-925.969;1.113845;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;11;-1664,-256;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TauNode;18;-1225.513,58.81031;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-1536,1280;Inherit;False;Property;_TimeScale;TimeScale;1;0;Create;True;0;0;False;0;False;-5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-720,1536;Inherit;False;Property;_JitterTime;JitterTime;2;0;Create;True;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-512,1280;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;52;-336,1536;Inherit;True;Property;_NoiseTex;NoiseTex;5;0;Create;True;0;0;False;0;False;-1;cec68983e3a915f48a8c454acb74d8fd;cec68983e3a915f48a8c454acb74d8fd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;65;0,1712;Inherit;False;Property;_JitterValue;JitterValue;4;0;Create;True;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;1193.33,1250.188;Inherit;False;Property;_Intensity;Intensity;3;0;Create;True;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;1384.455,1228.631;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;1328,896;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;84;1463.7,773.3829;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;112;1658.799,901.1062;Inherit;False;Property;_Color;Color;6;1;[HDR];Create;True;0;0;False;0;False;0,0.1654572,0.2264151,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;87;1468.636,472.0945;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ScreenColorNode;10;1772.902,483.3902;Inherit;False;Global;_GrabScreen0;Grab Screen 0;0;0;Create;True;0;0;False;0;False;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;109;1921.938,663.3155;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;1664,1408;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;108;2029.249,487.2441;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=8449ED0FC46CA762CDA9ADC15D5FB67A0237CDC0