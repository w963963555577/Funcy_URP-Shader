    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                half3 appendResult73 = (half3(0.0 , sin( _TimeParameters.x ) , 0.0));
                half3 temp_output_76_0 = ( appendResult73 * _FlowModel );
                
                half3 ase_worldNormal = TransformObjectToWorldNormal(v.normalOS);
                o.ase_texcoord4.xyz = ase_worldNormal;
                
                half3 temp_output_81_0 = ( v.positionOS.xyz + temp_output_76_0 );
                half3 vertexPos83 = temp_output_81_0;
            ...
            half4 frag(VertexOutput IN ): SV_Target
            {
                ...
                half4 temp_output_42_0 = ( _Color * tex2DNode6 );
                half3 appendResult35 = (half3(temp_output_42_0.rgb));
                float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - positionWSition );
                ase_worldViewDir = normalize(ase_worldViewDir);
                half3 ase_worldNormal = IN.ase_texcoord4.xyz;
                half dotResult14 = dot( ase_worldViewDir , ase_worldNormal );
                half dotResult21 = dot( ase_worldViewDir , ( _MainLightPosition.xyz - ( ase_worldNormal * 0.82 ) ) );
                half smoothstepResult27 = smoothstep( ( 1.0 - _EdgeLightWidth ) , ( 1.0 - ( _EdgeLightWidth * 0.7 ) ) , max( ( 1.0 - dotResult14 ) , max( dotResult21 , 0.0 ) ));
                half fresnel_edge_light32 = ( smoothstepResult27 * _EdgeLightIntensity );
                half3 lerpResult34 = lerp( appendResult35 , float3( 1,1,1 ) , fresnel_edge_light32);
                half3 appendResult110 = (half3(_EmissionColor.rgb));
                half3 appendResult108 = (half3(tex2DNode6.rgb));
                half3 baseColor107 = appendResult108;
                float2 uv_mask = IN.ase_texcoord3.xy * _mask_ST.xy + _mask_ST.zw;
                half4 tex2DNode58 = tex2D( _mask, uv_mask );
                half emMask85 = tex2DNode58.r;
                half3 temp_output_55_0 = ( appendResult110 * baseColor107 * emMask85 );
                half mulTime96 = _TimeParameters.x * 3.0;
                half smoothstepResult102 = smoothstep( 0.99 , 1.0 , ( abs( ( IN.ase_texcoord3.zw.y - 0.5 ) ) * 2.0 ));
                
                half2 appendResult49 = (half2(IN.ase_texcoord5.xyz.x , IN.ase_texcoord5.xyz.y));
                half2 panner46 = ( 0.5 * _Time.y * float2( -1,-0.5 ) + appendResult49);
                half simplePerlin2D44 = snoise( panner46*4.0 );
                simplePerlin2D44 = simplePerlin2D44*0.5 + 0.5;
                half smoothstepResult50 = smoothstep( 0.0 , 0.05 , ( tex2DNode6.a * simplePerlin2D44 ));
                float4 screenPos83 = IN.ase_texcoord6;
                half4 ase_screenPosNorm83 = screenPos83 / screenPos83.w;
                ...
                half distanceDepth83 = abs( ( screenDepth83 - LinearEyeDepth( ase_screenPosNorm83.z,_ZBufferParams ) ) / ( 1.0 ) );
...
/*ASEBEGIN
Version=18909
0;666;1920;343;564.2533;915.8331;1.526705;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;114;384,128;Inherit;False;Global;_FlowModel;_FlowModel;4;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;56;384,-512;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=6B2D38FFD17E4D0BFE02E9A3E82DF98CBEB19E41