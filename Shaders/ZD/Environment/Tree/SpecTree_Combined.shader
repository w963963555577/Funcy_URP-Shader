Shader "ZDShader/URP/Environment/SpecialTree_Combined"
{
    Properties
    {
        ...
        _TreePropertiesMap ("Tree Properties Map", 2DArray) = "black" { }
        [HideInInspector] _ClipThreshod ("ClipThreshod", Range(0, 1)) = 0.4
        [HideInInspector] _LambertOffset ("LambertOffset", Float) = 0.5
        [HideInInspector] [HDR]_BlendColor_Light ("BlendColor_Light", Color) = (0.227451, 0.8784314, 0.4121743, 0)
        [HideInInspector] [HDR]_BlendColor_Mid ("BlendColor_Mid", Color) = (0.03555536, 0.4433962, 0.1661608, 0)
        [HideInInspector] [HDR]_BlendColor_Dark ("BlendColor_Dark", Color) = (0, 0.254717, 0.1783019, 0)
        [HideInInspector] [HDR]_BlendColor_SelfShadow ("BlendColor_SelfShadow", Color) = (0, 0.1776338, 0.2, 0)
        [HideInInspector] [HDR]_SpecColor ("SpecColor", Color) = (0.227451, 1.498039, 0, 1)
        [HideInInspector] _SpecularOffset ("SpecularOffset", Float) = 0.44
        [HideInInspector] _Speed ("Speed", Float) = 1.5
        [HideInInspector] _Amount ("Amount", Float) = 5
        [HideInInspector] _Distance ("Distance", Range(0, 1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct VertexOutput
            {
                ...
                half3 p0: TEXCOORD5;
                half3 p1: TEXCOORD6;
                half4 blendColor_Light: COLOR0;
                half4 blendColor_Mid: COLOR1;
                half4 blendColor_Dark: COLOR2;
                half4 blendColor_SelfShadow: COLOR3;
                half4 specColor: COLOR4;
            ...
            #include "SpecTree_Combined-CBufferProperties.hlsl"
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                GetProperties(v.uv1.xy, o.p0, o.p1, o.blendColor_Light, o.blendColor_Mid, o.blendColor_Dark, o.blendColor_SelfShadow, o.specColor);
            ...
            half4 frag(VertexOutput IN): SV_Target
            {
                ...
                _ClipThreshod = IN.p0.x;
                _LambertOffset = IN.p0.y;
                _SpecularOffset = IN.p0.z;
                
                _BlendColor_Light = IN.blendColor_Light;
                _BlendColor_Mid = IN.blendColor_Mid;
                _BlendColor_Dark = IN.blendColor_Dark;
                _BlendColor_SelfShadow = IN.blendColor_SelfShadow;
                _SpecColor = IN.specColor;
        ...
        Pass
        {
            ...
            Varyings ShadowPassVertex(Attributes input)
            {
                ...
                GetBaseProperties(input.uv1.xy, output.p0, output.p1);
                
                _Speed = output.p1.x;
                _Amount = output.p1.y;
                _Distance = output.p1.z;
            ...
            half4 ShadowPassFragment(Varyings input): SV_TARGET
            {
                ...
                _ClipThreshod = input.p0.x;
                _LambertOffset = input.p0.y;
                _SpecularOffset = input.p0.z;
