    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float distanceDepth112 = abs( ( screenDepth112 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Depth ) );
				float temp_output_359_0 = saturate( pow( ( 1.0 - saturate( distanceDepth112 ) ) , 4.0 ) );
				float4 lerpResult372 = lerp( float4( float3(0,0,0) , 0.0 ) , _FoamColor , float4( saturate( ( (tex2D( _MainTex, uv_Foam0326 )).rgb + (tex2D( _MainTex, uv_Foam1324 )).rgb + pow( temp_output_359_0 , 3.0 ) ) ) , 0.0 ));
...
/*ASEBEGIN
Version=17500
14;11;1426;838;-276.5054;-2521.538;1.285;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;337;-2987.417,-132.9651;Inherit;False;Property;_Speed;Speed;5;0;Create;True;0;0;False;0;1;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;322;-2462.073,863.561;Inherit;False;Property;_FoamScale3;Foam Scale (1=1 meter);4;0;Create;False;0;0;False;0;1;14.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;41;-544.4187,2239.383;Inherit;True;Property;_MainTex;MainTex;1;1;[NoScaleOffset];Create;True;0;0;False;0;199d83fd2aca7214481411272c61f368;94b2470d29df55e4fad7f0aee4b2243f;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;367;1119.87,2852.022;Inherit;False;Property;_FoamColor;FoamColor;0;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1.277174,1.684005,2.530476,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;373;1183.534,2659.468;Inherit;False;Constant;_Vector0;Vector 0;6;0;Create;True;0;0;False;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;375;1169.692,3280.669;Inherit;False;Property;_Soft;Soft;6;0;Create;True;0;0;False;0;0;3;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;372;1433.637,2937.266;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DepthFade;374;1452.388,3213.051;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;219;1746.885,2976.997;Float;False;True;-1;2;ASEMaterialInspector;0;3;ZDShader/LWRP/Environment/ToonWaterFall;e2514bdcf5e5399499a9eb24d175b9db;True;Base;0;0;Base;5;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;4;1;False;-1;1;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;Hidden/InternalErrorShader;0;0;Standard;8;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;0;Receive Shadows;0;Built-in Fog;0;LOD CrossFade;0;Vertex Position,InvertActionOnDeselection;1;0;3;True;False;False;False;;0
...
ASEEND*/
//CHKSM=E3BBEB948689080AAEF6FBA8A6A91556A8873698