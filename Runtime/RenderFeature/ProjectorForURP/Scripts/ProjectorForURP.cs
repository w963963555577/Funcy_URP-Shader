...
namespace ProjectorForURP
{
	...
	public class ProjectorForURP : ProjectorForSRP.ProjectorForSRP, ICustomRenderer
	{
		// serialize field
		...
		public void CopySerializedPropertiesFrom(ProjectorForURP src)
		{
