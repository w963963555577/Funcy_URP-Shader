...
namespace UnityEngine.Funcy.LWRP.Runtime
{
    ...
    internal class Reflection : MonoBehaviour
    {
        #region Variables
        ...
        public bool isDisableReflectionShadows = true;
    ...
    public bool disableInEditMode;
        ...
        if (disableInEditMode && !Application.isPlaying)
        {
            ...
            Camera cam = Application.isPlaying ? Camera.main : Camera.current;
            if (!cam) return;
        ...
        private void UpdateCameraModes(Camera src, Camera dest)
        {
            ...
            dest.farClipPlane = reflectionCamFarClippingPlane;
