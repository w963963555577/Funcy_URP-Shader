Shader "Andrew/Mobile/Mobile_Tiles_2_Maps"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass 
		{
			...
			float4 frag(VertexOutput i) : SV_Target
			{
				...
				float4 _Layer1Color = tex2D(_Layer1,TRANSFORM_TEX(i.uv1, _Layer1));
				float4 _Layer2Color = tex2D(_Layer2, TRANSFORM_TEX(i.uv1, _Layer2));
				float3 _diffuse = _Color * _BaseColor;
				_diffuse = _diffuse * (1 - _Layer1Color.a) + _Layer1Color.rgb*_Layer1Color.a;
				_diffuse = _diffuse * (1 - _Layer2Color.a) + _Layer2Color.rgb*_Layer2Color.a;
